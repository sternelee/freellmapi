...
export async function seedModels(db: D1DB): Promise<void> {
  ...
  const models: [string, string, string, number, number, string, number | null, number | null, number | null, number | null, string, number][] = [
    ...
    ['zenmux', 'google/gemini-3.5-flash-free', 'Gemini 3.5 Flash Free', 20, 5, 'Large', 10, null, null, null, '~1M', 1000000],
    ['zenmux', 'z-ai/glm-4.7-flash-free', 'GLM-4.7 Flash Free', 19, 4, 'Large', 10, null, null, null, '~1M', 131072],
    ['zenmux', 'z-ai/glm-4.6v-flash-free', 'GLM-4.6V Flash Free', 21, 4, 'Large', 10, null, null, null, '~1M', 131072],
    ['zhipu', 'glm-4.5-flash', 'GLM-4.5 Flash', 24, 4, 'Large', null, null, null, 1000000, '~30M', 131072],
    ['zai', 'glm-4.5-flash', 'GLM-4.5 Flash (Z.ai)', 24, 4, 'Large', null, null, null, 1000000, '~30M', 131072],
